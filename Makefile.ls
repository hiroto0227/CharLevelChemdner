...
preprocess:
	python3.7 preprocess/preprocess.py --input-dir ./Repository/Chemdner/train --mode LastSync --output-path ./Repository/SeqData/train_ls.csv --sp-model ./Repository/SentencePieceModel/sp64000.model ./Repository/SentencePieceModel/sp32000.model ./Repository/SentencePieceModel/sp16000.model ./Repository/SentencePieceModel/sp8000.model ./Repository/SentencePieceModel/sp4000.model ./Repository/SentencePieceModel/sp2000.model;
	python3.7 preprocess/preprocess.py --input-dir ./Repository/Chemdner/valid --mode LastSync --output-path ./Repository/SeqData/valid_ls.csv --sp-model ./Repository/SentencePieceModel/sp64000.model ./Repository/SentencePieceModel/sp32000.model ./Repository/SentencePieceModel/sp16000.model ./Repository/SentencePieceModel/sp8000.model ./Repository/SentencePieceModel/sp4000.model ./Repository/SentencePieceModel/sp2000.model;
	python3.7 preprocess/preprocess.py --input-dir ./Repository/Chemdner/test --mode LastSync --output-path ./Repository/SeqData/test_ls.csv --sp-model ./Repository/SentencePieceModel/sp64000.model ./Repository/SentencePieceModel/sp32000.model ./Repository/SentencePieceModel/sp16000.model ./Repository/SentencePieceModel/sp8000.model ./Repository/SentencePieceModel/sp4000.model ./Repository/SentencePieceModel/sp2000.model;

train:
	python3.7 model/charRedundant.py --mode train --config-path model/last_sync_ver1.config --word2vec-path ./Repository/Pretrained/gv_pretrain_sp64000.model ./Repository/Pretrained/gv_pretrain_sp32000.model ./Repository/Pretrained/gv_pretrain_sp16000.model ./Repository/Pretrained/gv_pretrain_sp8000.model ./Repository/Pretrained/gv_pretrain_sp4000.model ./Repository/Pretrained/gv_pretrain_sp2000.model;

predict:
	python3.7 model/charRedundant.py --mode predict --config-path model/last_sync_ver1.config --word2vec-path ./Repository/Pretrained/gv_pretrain_sp64000.model ./Repository/Pretrained/gv_pretrain_sp32000.model ./Repository/Pretrained/gv_pretrain_sp16000.model ./Repository/Pretrained/gv_pretrain_sp8000.model ./Repository/Pretrained/gv_pretrain_sp4000.model ./Repository/Pretrained/gv_pretrain_sp2000.model;

evaluate:
	python3.7 evaluate/evaluate.py --input-path ./Repository/SeqData/predicted_ls.csv;
